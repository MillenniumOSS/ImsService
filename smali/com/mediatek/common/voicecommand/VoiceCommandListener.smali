...
.field public static final ACTION_VOICE_TRAINING_DATA:I = 0x18
...
.field public static final ACTION_VOICE_TRAINING_RETRY:I = 0x17
...
.field public static final ACTION_VOICE_WAKEUP_MODEL_BROKEN:I = 0x9
...
.method static constructor <clinit>()V
    ...
    const-string v2, "ACTION_VOICE_COMMON_COMMAND_PATH"

    const-string v3, "ACTION_VOICE_COMMON_PROCESS_STATE"

    const-string v4, "ACTION_VOICE_COMMON_KEYWORD"
    ...
    const-string v4, "ACTION_VOICE_UI_START"

    const-string v5, "ACTION_VOICE_UI_STOP"

    const-string v6, "ACTION_VOICE_UI_ENABLE"

    const-string v7, "ACTION_VOICE_UI_DISALBE"

    const-string v8, "ACTION_VOICE_UI_NOTIFY"
    ...
    const-string v28, "ACTION_VOICE_TRAINING_DATA"

    filled-new-array/range {v4 .. v28}, [Ljava/lang/String;

    move-result-object v4

    const-string v5, "ACTION_VOICE_RECOGNITION_INTENSITY"

    const-string v6, "ACTION_VOICE_RECOGNITION_NOTIFY"

    const-string v7, "ACTION_VOICE_RECOGNITION_START"

    filled-new-array {v0, v7, v5, v6}, [Ljava/lang/String;

    move-result-object v5

    const-string v6, "EMPTY"

    const-string v7, "ACTION_VOICE_CONTACTS_START"

    const-string v8, "ACTION_VOICE_CONTACTS_STOP"

    const-string v9, "ACTION_VOICE_CONTACTS_ENABLE"

    const-string v10, "ACTION_VOICE_CONTACTS_DISABLE"

    const-string v11, "ACTION_VOICE_CONTACTS_INTENSITY"

    const-string v12, "ACTION_VOICE_CONTACTS_SELECTED"

    const-string v13, "ACTION_VOICE_CONTACTS_NOTIFY"

    const-string v14, "ACTION_VOICE_CONTACTS_NAME"

    const-string v15, "ACTION_VOICE_CONTACTS_SPEECH_DETECTED"

    const-string v16, "ACTION_VOICE_CONTACTS_SEARCH_COUNT"

    const-string v17, "ACTION_VOICE_CONTACTS_ORIENTATION"

    const-string v18, "ACTION_VOICE_CONTACTS_RECOGNITION_ENABLE"

    const-string v19, "ACTION_VOICE_CONTACTS_RECOGNITION_DISABLE"
    ...
    const-string v8, "ACTION_VOICE_WAKEUP_START"

    const-string v9, "ACTION_VOICE_WAKEUP_ENABLE"

    const-string v10, "ACTION_VOICE_WAKEUP_DISABLE"

    const-string v11, "ACTION_VOICE_WAKEUP_NOTIFY"

    const-string v12, "ACTION_VOICE_WAKEUP_INIT"

    const-string v13, "ACTION_VOICE_WAKEUP_MODE"

    const-string v14, "ACTION_VOICE_WAKEUP_COMMAND_STATUS"

    const-string v15, "ACTION_VOICE_WAKEUP_READ_STATUS"

    const-string v16, "ACTION_VOICE_WAKEUP_MODEL_BROKEN"
    ...
    const-string v9, "ACTION_VOICE_TRIGGER_START"

    const-string v10, "ACTION_VOICE_TRIGGER_ENABLE"

    const-string v11, "ACTION_VOICE_TRIGGER_DISABLE"

    const-string v12, "ACTION_VOICE_TRIGGER_NOTIFY_ARRIVED"

    const-string v13, "ACTION_VOICE_TRIGGER_NOTIFY_DETECTED"

    const-string v14, "ACTION_VOICE_TRIGGER_INIT"

    const-string v15, "ACTION_VOICE_TRIGGER_MODE"

    const-string v16, "ACTION_VOICE_TRIGGER_COMMAND_STATUS"

    const-string v17, "ACTION_VOICE_TRIGGER_MODIFY_PARAM"

    const-string v18, "ACTION_VOICE_TRIGGER_QUERY_PARAM"

    const-string v19, "ACTION_VOICE_TRIGGER_SET_LOCALE"

    const-string v20, "ACTION_VOICE_TRIGGER_GET_LOCALE"

    const-string v21, "ACTION_VOICE_TRIGGER_READ_STATUS"

    const-string v22, "ACTION_VOICE_TRIGGER_GET_INITIAL_PARAMS"

    const-string v23, "ACTION_VOICE_TRIGGER_NOTIFY_PACKAGE_CHANGED"
    ...
    .line 889
    const-string v0, "VOICE_WAKEUP_MODE_SPEAKER_DEPENDENT"

    const-string v1, "VOICE_WAKEUP_MODE_TRIGGER"

    const-string v2, "VOICE_WAKEUP_MODE_UNLOCK"

    const-string v3, "VOICE_WAKEUP_MODE_SPEAKER_INDEPENDENT"
    ...
    .line 896
    const-string v0, "VOICE_WAKEUP_STATUS_COMMAND_UNCHECKED"

    const-string v1, "VOICE_WAKEUP_STATUS_COMMAND_CHECKED"

    const-string v2, "VOICE_WAKEUP_STATUS_NOCOMMAND_UNCHECKED"
    ...
    .line 902
    const-string v0, "VOICE_TRAINING_PARAM_CONFIDENCE_THRESHOLD"

    const-string v1, "VOICE_TRAINING_PARAM_REPEAT_TIMES"

    const-string v2, "VOICE_TRAINING_PARAM_TIMEOUT"
    ...
    .line 908
    const-string v0, "VOICE_TRIGGER_SECOND_STAGE_THRESHOLD"

    const-string v1, "VOICE_TRIGGER_ANTI_SPOOF_THRESHOLD"

    const-string v2, "VOICE_TRIGGER_PARAM_COARSE_CONFIDENCE"
